...
var user = prompt('What is your name?');
      ...
      alert('Hello, ' + user + '. I\'m going to ask you a question.');

      var answer1 = prompt(user + ' this is a yes or no question, so please answer with a Y or N. Did Miya come to Seattle from Florida 4 years ago?');
